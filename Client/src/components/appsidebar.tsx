...
export default function AppSidebar() {
  ...
  useEffect(() => {
    ...
    fetchOutline();
    // cleanup run te sideffect to set the coursetitle , lessonstitle , moduletitle == null
    return () => {
      setCourseTitle(null);
      setLessonTitle(null);
      setModuleTitle(null);
  ...
  return (
    <Sidebar className="bg-zinc-900 border-zinc-700" variant="sidebar">
      <SidebarHeader className="bg-zinc-900 text-white text-lg font-bold px-4 py-2 border-b border-zinc-700">
        {courseOutline?.title}
      </SidebarHeader>
